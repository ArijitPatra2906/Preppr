...
export default async function LandingPage() {
  ...
  return (
    <div className='min-h-screen bg-stone-50 text-stone-900'>
      ...
      <section className='relative overflow-hidden bg-gradient-to-br from-orange-50 via-stone-50 to-orange-100/30'>
        {/* Decorative Elements */}
        ...
        <div className='relative max-w-7xl mx-auto px-4 py-20 md:py-32'>
          <div className='grid md:grid-cols-2 gap-12 items-center'>
            ...
            <div className='order-2 md:order-1 text-center md:text-left'>
              <div className='inline-flex items-center gap-2 bg-white border-2 border-stone-900 px-4 py-2 mb-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]'>
              ...
              <p className='text-lg md:text-xl text-stone-600 mb-10 max-w-xl mx-auto md:mx-0 leading-relaxed'>
              ...
              <div className='flex flex-col sm:flex-row gap-4 justify-center md:justify-start'>
                <Link href='/dashboard'>
                  <Button
                    size='xl'
                    className='bg-stone-900 hover:bg-stone-800 text-white border-2 border-stone-900 shadow-[4px_4px_0px_0px_rgba(249,115,22,1)] hover:shadow-[2px_2px_0px_0px_rgba(249,115,22,1)] transition-all'
                  >
                    Get Started Free
                ...
                {/* <Button
                  size='xl'
                  variant='outline'
                  className='border-2 border-stone-900 bg-white hover:bg-stone-50 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all'
                >
                  Watch Demo
                </Button> */}
              </div>
            ...
            <div className='order-1 md:order-2 relative'>
              <div className='grid grid-cols-2 gap-4'>
                {/* Large Featured Card */}
                <div className='col-span-2 relative h-72 bg-white border-4 border-stone-900 rounded-lg overflow-hidden shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]'>
                  <Image
                    src='/pasta-dish.png'
                    alt='Featured dish'
                    fill
                ...
                {/* Bottom Cards */}
                <Card className='border-4 border-stone-900 bg-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] py-0'>
      ...
      <section className='py-20 md:py-12 px-4 bg-stone-50'>
            ...
            {FEATURES.map((feature, index) => {
              ...
              return (
                <Card
                  ...
                  } border-4 border-stone-900 bg-white hover:bg-orange-50 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(249,115,22,1)] transition-all group py-0 cursor-pointer`}
                >
                  <CardContent className='p-8'>
                    <div className='flex items-start justify-between mb-6'>
                      <div className='p-4 bg-orange-100 border-2 border-stone-900 group-hover:bg-orange-600 group-hover:text-white transition-colors'>
                        <IconComponent className='w-8 h-8' />
                      </div>
                      <Badge className='bg-stone-100 text-stone-900 border-2 border-stone-900 font-mono text-xs'>
                        {feature.limit}
                      </Badge>
                    </div>
                    <h3 className='text-2xl font-black mb-3 group-hover:text-orange-600 transition-colors'>
                      {feature.title}
                    </h3>
      ...
      <section className='py-20 px-4 bg-gradient-to-br from-orange-50 to-stone-50'>
        <div className='max-w-5xl mx-auto text-center'>
          ...
          <div className='grid md:grid-cols-3 gap-6'>
            {[
              ...
              <Card
                key={i}
                className='border-4 border-stone-900 bg-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] py-0'
              >
      ...
      {subscriptionTier === 'free' && (
        <section className='py-20 md:py-32 px-4 bg-stone-50'>
          <PricingSection subscriptionTier={subscriptionTier} />
        </section>
      )}

      {/* Final CTA */}
      <section className='py-20 px-4 bg-white border-y-4 border-stone-900'>
